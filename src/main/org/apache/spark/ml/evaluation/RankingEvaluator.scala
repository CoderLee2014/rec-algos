...
class RankingEvaluator(override val uid: String)
  ...
  val topK: IntParam = new IntParam(this, "topK", "k")
  ...
  val metricName: Param[String] = {
    val allowedParams = ParamValidators.inArray(Array("precisionAtk","ndcgAt", "map", "mapk", "recallAtK", "diversityAtK",
  ...
  setDefault(nItems -> -1, metricName -> "ndcgAt", topK -> 10)
  ...
  def getMetrics(dataset: Dataset[_]): AdvancedRankingMetrics = {
    ...
    new AdvancedRankingMetrics(predictionAndLabels, getTopK, getNItems)
  }
